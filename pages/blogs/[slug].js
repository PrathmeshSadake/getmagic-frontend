...
// const BlogPost = ({ blog }) => {
//   return (
//     <section class="blog-section py-20">
//       <div class="container mx-auto px-4">
//         <div class="max-w-4xl mx-auto">
//           <div class="mb-12">
//             <h2
//               class="mb-3 text-3xl lg:text-4xl font-bold font-heading"
//               data-config-id="title1"
//             >
//               {blog.headline}
//             </h2>
//             {/* <p
//               class="text-xs mx-auto font-semibold text-gray-500"
//               data-config-id="date5"
//             >
//               {formatDate(blog.published_at.toString())}
//             </p> */}
//           </div>

//           <img
//             class="mb-12 rounded object-cover mx-auto"
//             src={blog.image[0].formats.large.url}
//             alt=""
//             data-config-id="image1"
//           />
//           {blog.subheading && (
//             <h2
//               class="mb-12 text-3xl lg:text-4xl font-bold font-heading"
//               data-config-id="title1"
//             >
//               {blog.subheading}
//             </h2>
//           )}
//           <h2
//             class="mb-12 text-xl lg:text-2xl font-semibold font-heading"
//             data-config-id="title1"
//           >
//             {blog.description}
//           </h2>
//           <div className="mt-5 text-md md:text-lg md:leading-relaxed font-normal text-gray-600">
...
// //     `${process.env.APP_URL}/blogs/${params.slug}`
// //   );
// //   return {
// //     props: { blog: data },
// //   };
...
//   const { data } = await axios.get(`${process.env.APP_URL}/blogs`);
